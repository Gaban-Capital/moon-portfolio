...
const Privacy: FC<pageProps> = ({}) => {
  return (
    <main>
      ...
      <h1>Privacy Policy for MoonPortfolio.xyz</h1>
      ...
      <p>
        ...
        and password, which you voluntarily give to us when you choose to
      ...
      <p>
        ...
        Application, such as your IP address, browser type, operating system,
      ...
      <p>
        Financial information, such as data related to your cryptocurrency
        portfolio, is primarily in encrypted form. We only have limited access
        to or collect financial information you voluntarily share with us.
      </p>
      ...
      <p>
        ...
        Authentication, Apple ID, etc.], including your name, your social
      ...
      <p>
        We may use the information collected about you via the Application to:
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          information regarding promotions and the Application.
        </li>
      ...
      <p>
        We do not sell, rent, or lease our customer lists to third parties. Your
        information can be disclosed in the following ways:
      </p>
      ...
      <p>
        ...
        Application, your posts may be viewed by all users and may be publicly
        distributed outside the Application.
      </p>
      ...
      <ul>
        <li>
          <strong>Cookies and Web Beacons:</strong> We may use cookies, web
          beacons, tracking pixels, and other tracking technologies on the
          Application to help customize the Application and improve your
          experience.
        </li>
        <li>
          <strong>Google Analytics and Hotjar:</strong> We use Google Analytics
          and Hotjar to understand and analyze web traffic and user behavior on
          the Application.
        </li>
      </ul>
      ...
      <p>
        ...
        contact us at:{' '}
        <a href="mailto:hello@moonportfolio.xyz">hello@moonportfolio.xyz</a>.
      </p>
    </main>
  );
};
